...
<div class="container-fluid"> 
    ...
    <div class="row">
        ...
        <div class="col-sm-12 text-center" style="height: 50px; background-color: black; color: orange;"><h1>WELCOME USER( <?php echo $admin ?>)</h1></div>
    </div>
...
<div class="row">
  ...
  <div class="col-sm-12 text-center" style="height: 50px; background-color: black; font-size: 18px;line-height: 50px; ">
    ...
    <span  style="height: 50px; background-color: black; color: white;"> devvelop by sumit | </span>
  </div>
</div>
